...
<div class="form-group">
    <div class="row">
        <div class="col-lg-3">
            <label for="name" class="col-form-label">Pangkat Golongan</label>
        </div>
        <div class="col-lg-9">
            {!! Form::text('name', null, ['class' => 'form-control', 'placeholder'=>'Nama Pangkat Golongan']) !!}
...
<div class="form-group">
    <div class="row">
        ...
        <div class="col-lg-9">
            {!! Form::text('sign_by', null, ['class' => 'form-control', 'placeholder'=>'sign_by']) !!}
