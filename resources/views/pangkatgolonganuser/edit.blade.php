            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        --}}
                        {{ Form::model($pangkatgolongan, array('method' => 'PATCH', 'url' => route('pangkatgolonganuser.update', $pangkatgolongan->rank_group_id), 'files' => true)) }}
                            @include('pangkatgolonganuser._form')
                            <div>
