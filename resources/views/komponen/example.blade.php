    ...
    <div class="card-body">
        ...
        <div class="btn-toolbar d-none d-md-block" role="toolbar" aria-label="Toolbar with buttons">
            ...
            <svg class="c-icon">
                <use xlink:href="{{ asset('template/@coreui/icons/sprites/free.svg#cil-cloud-download') }}"></use>
            </svg>
            </button>
        </div>
        </div>
    ...
    <div class="col-sm-6 col-lg-4">
        ...
        <div class="card-header bg-facebook content-center">
            ...
            <use xlink:href="{{ asset('template/@coreui/icons/sprites/brand.svg#cib-facebook-f') }}"></use>
            </svg>
        </div>
    ...
    <div class="col-sm-6 col-lg-4">
        ...
        <div class="card-header bg-twitter content-center">
            <svg class="c-icon c-icon-3xl text-white my-4">
            <use xlink:href="{{ asset('template/@coreui/icons/sprites/brand.svg#cib-twitter') }}"></use>
            </svg>
        </div>
        <div class="card-body row text-center">
            <div class="col">
    ...
    <div class="col-sm-6 col-lg-4">
        ...
        <div class="card-header bg-linkedin content-center">
            <svg class="c-icon c-icon-3xl text-white my-4">
            <use xlink:href="{{ asset('template/@coreui/icons/sprites/brand.svg#cib-linkedin') }}"></use>
            </svg>
        </div>
        <div class="card-body row text-center">
            <div class="col">
    ...
    <div class="col-md-12">
        ...
        <div class="card-body">
            ...
            <div class="col-sm-6">
                ...
                <div class="progress-group-header">
                    <svg class="c-icon progress-group-icon">
                    <use xlink:href="{{ asset('template/@coreui/icons/sprites/free.svg#cil-user-female') }}"></use>
                    </svg>
                    <div>Female</div>
                ...
                <div class="progress-group-header align-items-end">
                    <svg class="c-icon progress-group-icon">
                    <use xlink:href="{{ asset('template/@coreui/icons/sprites/brand.svg#cib-google') }}"></use>
                    </svg>
            ...
            <thead class="thead-light">
                ...
                <th class="text-center">
                    <svg class="c-icon">
                    <use xlink:href="{{ asset('template/@coreui/icons/sprites/free.svg#cil-people') }}"></use>
                    </svg>
                </th>
                <th>User</th>
            ...
            <tbody>
                ...
                <td class="text-center">
                    ...
                    <use xlink:href="{{ asset('template/@coreui/icons/sprites/flag.svg#cif-us') }}"></use>
                    </svg>
                </td>
                <td>
                    <div class="clearfix">
                ...
                <td class="text-center">
                    <svg class="c-icon c-icon-xl">
                    <use xlink:href="{{ asset('template/@coreui/icons/sprites/brand.svg#cib-cc-mastercard') }}"></use>
                    </svg>
                </td>
                <td>
                ...
                <tr>
                <td class="text-center">
                    <div class="c-avatar"><img class="c-avatar-img" src="{{ asset('template/assets/img/avatars/2.jpg') }}" alt="user@email.com"><span class="c-avatar-status bg-danger"></span></div>
                </td>
                <td>
                ...
                <td class="text-center">
                    <svg class="c-icon c-icon-xl">
                    <use xlink:href="{{ asset('template/@coreui/icons/sprites/flag.svg#cif-br') }}"></use>
                    </svg>
                </td>
                <td>
                    <div class="clearfix">
                ...
                <td class="text-center">
                    <svg class="c-icon c-icon-xl">
                    <use xlink:href="{{ asset('template/@coreui/icons/sprites/brand.svg#cib-cc-visa') }}"></use>
                    </svg>
                </td>
                <td>
                ...
                <td class="text-center">
                    <svg class="c-icon c-icon-xl">
                    <use xlink:href="{{ asset('template/@coreui/icons/sprites/flag.svg#cif-in')}}"></use>
                    </svg>
                </td>
                <td>
                    <div class="clearfix">
                ...
                <td class="text-center">
                    <svg class="c-icon c-icon-xl">
                    <use xlink:href="{{ asset('template/@coreui/icons/sprites/brand.svg#cib-cc-stripe') }}"></use>
                    </svg>
                </td>
                <td>
                ...
                <tr>
                <td class="text-center">
                    <div class="c-avatar"><img class="c-avatar-img" src="{{ asset('template/assets/img/avatars/4.jpg') }}" alt="user@email.com"><span class="c-avatar-status bg-secondary"></span></div>
                </td>
                <td>
                ...
                <td class="text-center">
                    <svg class="c-icon c-icon-xl">
                    <use xlink:href="{{ asset('template/@coreui/icons/sprites/flag.svg#cif-fr') }}"></use>
                    </svg>
                </td>
                <td>
                    <div class="clearfix">
                ...
                <td class="text-center">
                    <svg class="c-icon c-icon-xl">
                    <use xlink:href="{{ asset('template/@coreui/icons/sprites/brand.svg#cib-cc-paypal') }}"></use>
                    </svg>
                </td>
                <td>
                ...
                <td class="text-center">
                    <svg class="c-icon c-icon-xl">
                    <use xlink:href="{{ asset('template/@coreui/icons/sprites/flag.svg#cif-es') }}"></use>
                    </svg>
                </td>
                <td>
                    <div class="clearfix">
                ...
                <td class="text-center">
                    <svg class="c-icon c-icon-xl">
                    <use xlink:href="{{ asset('template/@coreui/icons/sprites/brand.svg#cib-cc-apple-pay') }}"></use>
                    </svg>
                </td>
                <td>
                ...
                <td class="text-center">
                    <svg class="c-icon c-icon-xl">
                    <use xlink:href="{{ asset('template/@coreui/icons/sprites/flag.svg#cif-pl') }}"></use>
                    </svg>
                </td>
                <td>
                    <div class="clearfix">
                ...
                <td class="text-center">
                    <svg class="c-icon c-icon-xl">
                    <use xlink:href="{{ asset('template/@coreui/icons/sprites/brand.svg#cib-cc-amex') }}"></use>
                    </svg>
                </td>
                <td>
